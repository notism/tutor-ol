						...
						<form action="insert_c.php" autocomplete="autocomplete" method="post" id="contact_form" class="contact_form">
							<div class="row contact_row">
								<div class="col-lg-6 contact_col">
									<h4>ชื่อวิชา : <input type="text" class="input1" name="c_name" value="วิทยาศาสตร์" maxlength="4" size="10" readonly="readonly">
								</div><br><br>
								<div class="col-lg-6 contact_col">
									<h4>ผู้สอน : <input type="text" class="input1" name="t_name" value="อาจารย์ สมศรี" maxlength="4" size="10" readonly="readonly">
								</div>		<br><br><br>
