				...
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_title">ภาษาไทย</div>
							<div class="intro_meta">
								<div class="intro_image"><img src="images/instructor_3.jpg" alt=""></div>
								<div class="intro_instructors">อาจารย์ ใหญ่   ● หัวหน้าติวเตอร์</a></div>
							</div>
						</div>
					</div>
				</div>
...
?><br><br><br><br>
							<form action="comment_t.php" method="post">
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="sidebar_top"><a href="thai_c.php">ลงทะเบียน</a></div>
