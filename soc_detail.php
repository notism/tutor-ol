				...
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_title">สังคมศึกษา</div>
							<div class="intro_meta">
								<div class="intro_image"><img src="images/instructor_4.jpg" alt=""></div>
								<div class="intro_instructors">อาจารย์ สมปอง  ● หัวหน้าติวเตอร์</a></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-9">
					<div class="tab_panels">
						...
						<div class="tab_panel description active">
							<div class="panel_title">เกี่ยวกับคอร์ส</div>
							<div class="panel_text">
								<p>เนื้อหาครอบคลุมรายวิชาสังคมศึกษา ศาสนาและวัฒนธรรม </p>
							</div>
...
?><br><br><br><br>
							<form action="comment_i.php" method="post">
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="sidebar_top"><a href="soc_c.php">ลงทะเบียน</a></div>
