				...
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_title">คณิตศาสตร์</div>
							<div class="intro_meta">
								<div class="intro_image"><img src="images/instructor_6.jpg" alt=""></div>
								<div class="intro_instructors">อาจารย์ สมใจ  ● หัวหน้าติวเตอร์</a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="tab_panels">
						...
						<div class="tab_panel description active">
							...
							<div class="panel_text">
								<p>คณิตศาสตร์ขั้นสูง เจาะลึกทุกการคำนวน</p>
...
?><br><br><br><br>
							<form action="comment_m.php" method="post">
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="sidebar_top"><a href="mat_c.php">ลงทะเบียน</a></div>
