					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									<li class="active"><a href="index_i.php">Home</a></li>									
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<h1 class="home_title">Hi, Admin</h1>
						
						<div class="home_button trans_200"><a href="allc.php">check class</a></div>
						<div class="home_button trans_200"><a href="add_course.php">Add Courses</a></div>
					</div>
				</div>
			</div>
		</div>
