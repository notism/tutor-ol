						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li class="active"><a href="stu.php">Students</a></li>
...
<body>  
	<div class="language">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="language_title">แก้ไขข้อมูล Students</div>
					<form method="POST" action="edit_stu.php"enctype="multipart/form-data" >
                      <?php
