...
<meta name="description" content="Tutor Online">
...
<div class="super_container">
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li><a href="teacher_1index.php">TUTOR</a></li>								
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						...
						<h5 class="home_title">TO</h5>
						<h1 class="home_title">TUTOR ONLINE</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="instructors">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center"> SPACIAL DAY</h2>
				</div>
			</div>
