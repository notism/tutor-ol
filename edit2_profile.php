		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<form method="POST" action="edit2_up.php"enctype="multipart/form-data" >
                      <?php
...
?>
                        ...
                        <div>
						 ...
						 <div> 
							...
							<div><div class="wrap-input100 validate-input m-t-85 m-b-35" >
									<select name="education" class="input100"required >
