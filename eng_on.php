						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li class="active"><a href="courses_online.php">Courses Online</a></li>
		...
		<div class="container">
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_1.jpg" alt=""></div>
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="vocabulaly.php"> เลือก</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_3.jpg" alt=""></div>
						<div class="course_body">
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="reading.php">เลือก</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_4.jpg" alt=""></div>
						<div class="course_body">
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="grammar.php"> เลือก</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_2.jpg" alt=""></div>
						<div class="course_body">
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="conver.php"> เลือก</a></div>
						</div>
					</div>
				</div>
