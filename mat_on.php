...
<div class="super_container">
	...
	<div class="language">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="language_title">คณิตศาสตร์</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_8.jpg" alt=""></div>
						<div class="course_body">
							
							<div class="course_info">
								<ul>
									
									<li>PAT 1 คณิตศาสตร์</a></li>
								</ul>
							</div>
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="pat1.php"> เลือก</a></div>
						</div>
					</div>
				</div>
                <!-- Course -->
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_9.jpg" alt=""></div>
						<div class="course_body">
							
							<div class="course_info">
								<ul>
									
									<li>9 วิชาสามัญ  หมวดคณิตศาสตร์</a></li>
								</ul>
							</div>
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="mat9.php"> เลือก</a></div>
						</div>
					</div>
				</div>
