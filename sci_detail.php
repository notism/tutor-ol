				...
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_title">วิทยาศาสตร์</div>
							<div class="intro_meta">
								<div class="intro_image"><img src="images/instructor_5.jpg" alt=""></div>
								<div class="intro_instructors">อาจารย์ สมศรี  ● หัวหน้าติวเตอร์</a></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-9">
					<div class="tab_panels">
						...
						<div class="tab_panel description active">
							<div class="panel_title">เกี่ยวกับคอร์สเรียน</div>
							<div class="panel_text">
								<p>ครอบคลุมทุกเนื้อหาวิทยาศาสตร์ ดาราศาสตร์และอื่นๆ</p>
							
							</div>
							
							<!-- Instructors -->
							<div class="instructors">
								<div class="panel_title">ติวเตอร์</div>
...
?><br><br><br><br>
							<form action="comment_s.php" method="post">
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="sidebar_top"><a href="sci_c.php">ลงทะเบียน</a></div>
								...
								<div class="features_content">
									<ul class="features_list">
										...
										<li class="d-flex flex-row align-items-start justify-content-start">
											<div class="feature_title"><i class="fa fa-clock-o" aria-hidden="true"></i><span>ระยะเวลาเรียน</span></div>
											<div class="feature_text ml-auto">1  ชั่วโมง</div>
										</li>
