		...
		<div class="container">
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/c_10.jpg" alt=""></div>
						<div class="course_body">
							
							<div class="course_info">
								<ul>
									
									<li>9 วิชาสามัญ หมวดวิชาสังคม</a></li>
								</ul>
							</div>
						...
						<div class="course_footer d-flex flex-row align-items-center justify-content-start">
							...
							<div class="course_mark course_free trans_200"><a href="so9.php"> เลือก</a></div>
						</div>
					</div>
				</div>
